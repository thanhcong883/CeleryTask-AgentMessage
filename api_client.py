...
def api_get(url: str, headers: dict = None, timeout: int = DEFAULT_TIMEOUT) -> Optional[requests.Response]:
    """
...
def api_post(url: str, json_data: dict, headers: dict = None, timeout: int = DEFAULT_TIMEOUT) -> Optional[requests.Response]:
    """
...
def api_put(url: str, json_data: dict, headers: dict = None, timeout: int = DEFAULT_TIMEOUT) -> Optional[requests.Response]:
    """
...
def find_user_role(members: list, platform_user_id: str) -> Optional[str]:
    ...
    """
    return next(
        (m.get("role_app") for m in members 
